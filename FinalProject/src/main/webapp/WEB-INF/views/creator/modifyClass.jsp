...
function classInfoPut(){
	document.getElementById('class_info').value= "${modify.class_info}";
...
<div class="container">
	...
	<div >
		<input type="text" name="class_name" class="inputCommonClass" placeholder="클래스명을 입력하세요" id="class_name" value="${modify.class_name }">
	...
	<div>
		<div id="summernoteForm">
  			<textarea id="summernote" name="class_content">${modify.class_content}</textarea>
		</div>
	</div>
	<div>
	...
	<div class="classAddress">
		<div id="classAddressInnerDiv">
			<input type="text" id="postcode" placeholder="우편번호" name="class_post_no" readonly="readonly" value="${modify.class_post_no}">
			<input type="button" onclick="execDaumPostcode()" value="주소검색" class="buttonClass"><br>
			<input type="text" id="roadAddress" placeholder="도로명주소" name="class_addr1" readonly="readonly" value="${modify.class_addr1 }">
			<span id="guide" style="color:#999;display:none"></span>
			<input type="text" id="detailAddress" placeholder="상세주소" name="class_addr2" value="${modify.class_addr2 }"/>
			<!-- 구글맵 -->
	...
	<div id="classFee">
		<span> 수강료 : </span><input type="text" name="class_price" class="inputCommonClass" placeholder="희망 수강료를 입력하세요" id="class_fee" value="${modify.class_price }"><kimin2>원</kimin2>
		<span> 최대인원 : </span><input type="text" name="max_headcount" class="inputCommonClass" placeholder="수강가능 최대인원을 입력하세요" id="class_nop" value="${modify.max_headcount }"><kimin2>명</kimin2>
	</div>
	<div>
		<ul class="descriptionUl">
			<li class="dsctitle">작성 Tip</li>
